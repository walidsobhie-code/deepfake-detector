...
[![Try on HF](https://img.shields.io/huggingface/spaces/my-ai-stack/deepfake-detector?color=blue&label=Try+Live+Demo)](https://huggingface.co/spaces/my-ai-stack/deepfake-detector)
